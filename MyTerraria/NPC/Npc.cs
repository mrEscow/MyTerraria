...
namespace MyTerraria.NPC
{
    ...
    abstract class Npc : Transformable, Drawable
    {
        ...
        public void Update()
        {
            ...
            // Если игрок упал в пропость, возрождаем его
        ...
        bool updateCollision(FloatRect rectNPC, FloatRect rectTile, DirectionType direction, ref Vector2f pos)
        {
            if (rectNPC.Intersects(rectTile))
            {
                ...
                switch (direction)
                {
                    ...
                    case DirectionType.Down: pos = new Vector2f(pos.X, rectTile.Top - rectTile.Height + 1); break;
                    case DirectionType.Left: pos = new Vector2f(rectTile.Left + rectTile.Width - 1, pos.Y); break;
                    case DirectionType.Right: pos = new Vector2f(rectTile.Left - rectTile.Width + 1, pos.Y); break;
                }
                */
